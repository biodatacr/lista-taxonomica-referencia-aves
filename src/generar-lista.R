...
INPUT_CHECKLIST <- "data/interim/avesdecostarica_2022.csv"
OUTPUT_CHECKLIST <- "data/processed/lista-taxonomica-referencia-aves.csv"
OUTPUT_NOTFOUND_CHECKLIST <- "data/processed/lista-taxonomica-referencia-aves-nombres-no-encontrados.csv"
...
input_checklist <- 
  input_checklist |>
  mutate(name = get_cleaned_species_name(Taxa))
